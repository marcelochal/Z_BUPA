...
*&      Form  UPD_FORNECEDOR
*&---------------------------------------------------------------------*
*FORM upd_fornecedor TABLES pt_banco          STRUCTURE zpf_banco
*                           pt_ir             STRUCTURE zpf_ir
*                           pt_tel_tab        STRUCTURE zpf_telefone
*                           pt_cel_tab        STRUCTURE zpf_celular
*                           pt_fax_tab        STRUCTURE zpf_fax
*                           pt_email_tab      STRUCTURE zpf_email
*                           pt_contato_tab    STRUCTURE zpf_contato
*                     USING ps_fornx          TYPE zpf_fornecedorx
*                           ps_forn           TYPE zpf_fornecedor
*                           p_lifnr           TYPE lifnr
*                           p_bukrs           TYPE t001-bukrs
*                           p_ekorg           TYPE eban-ekorg
*                  CHANGING pt_msg            TYPE ty_mensagem
...
*    l_idx    TYPE num2,
*    l_txt    TYPE fnam_____4,
*    ls_banco TYPE zpf_banco,
*    ls_ir    TYPE zpf_ir,
*    lt_lfbw  TYPE ty_lfbw,
*    p_subrc  TYPE sysubrc,
*    l_pos(3) TYPE c.
*
*  DATA:
*    ls_tel_tab     LIKE LINE OF pt_tel_tab,
*    ls_cel_tab     LIKE LINE OF pt_cel_tab,
*    ls_fax_tab     LIKE LINE OF pt_fax_tab,
*    ls_email_tab   LIKE LINE OF pt_email_tab,
*    ls_contato_tab LIKE LINE OF pt_contato_tab.
*
*  zcl_bdc=>reset( ).
*
**&- 1a Tela: Cadastro Fornecedor
*  zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0101' dynbg = 'X' ).
*  zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '/00' ).
*  zcl_bdc=>add( fnam = 'RF02K-LIFNR' fval = p_lifnr ).
*  zcl_bdc=>add( fnam = 'RF02K-BUKRS' fval = p_bukrs ).
*  zcl_bdc=>add( fnam = 'RF02K-EKORG' fval = p_ekorg ).
*  zcl_bdc=>add( fnam = 'RF02K-D0110' fval = 'X' ).
*  zcl_bdc=>add( fnam = 'RF02K-D0120' fval = 'X' ).
*  IF pt_banco[] IS NOT INITIAL.
*    zcl_bdc=>add( fnam = 'RF02K-D0130' fval = 'X' ).
*  ENDIF.
*  zcl_bdc=>add( fnam = 'WRF02K-D0380' fval = 'X' ).
*  zcl_bdc=>add( fnam = 'RF02K-D0210' fval = 'X' ).
*  zcl_bdc=>add( fnam = 'RF02K-D0215' fval = 'X' ).
*  zcl_bdc=>add( fnam = 'RF02K-D0220' fval = 'X' ).
*  IF pt_ir[] IS NOT INITIAL.
*    zcl_bdc=>add( fnam = 'RF02K-D0610' fval = 'X' ).
*  ENDIF.
*  zcl_bdc=>add( fnam = 'RF02K-D0310' fval = 'X' ).
*  zcl_bdc=>add( fnam = 'WRF02K-D0320' fval = 'X' ).
*  zcl_bdc=>add( fnam = 'USE_ZAV' fval = 'X' ).
*
******************************************************************************************************************************
**** Alterando os Telefones
******************************************************************************************************************************
*
*  IF pt_tel_tab[] IS NOT INITIAL.
*
*    zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0111' dynbg = 'X' ).
*    zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=$MTE' ).
*    IF ps_fornx-name1      = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-NAME1'      fval = ps_forn-name1 ).      ENDIF.
*    IF ps_fornx-sortl      = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-SORT1'      fval = ps_forn-sortl ).      ENDIF.
*    IF ps_fornx-street     = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-STREET'     fval = ps_forn-street ).     ENDIF.
*    IF ps_fornx-str_suppl3 = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-STR_SUPPL3' fval = ps_forn-str_suppl3 ). ENDIF.
*    IF ps_fornx-house_num1 = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-HOUSE_NUM1' fval = ps_forn-house_num1 ). ENDIF.
*    IF ps_fornx-house_num2 = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-HOUSE_NUM2' fval = ps_forn-house_num2 ). ENDIF.
*    IF ps_fornx-city2      = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-CITY2'      fval = ps_forn-city2 ).      ENDIF.
*    IF ps_fornx-post_code1 = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-POST_CODE1' fval = ps_forn-post_code1 ). ENDIF.
*    IF ps_fornx-city1      = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-CITY1'      fval = ps_forn-city1 ).      ENDIF.
*    IF ps_fornx-country    = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-COUNTRY'    fval = ps_forn-country ).    ENDIF.
*    IF ps_fornx-region     = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-REGION'     fval = ps_forn-region ).     ENDIF.
*    IF ps_fornx-tel_number = 'X'. zcl_bdc=>add( fnam = 'SZA1_D0100-TEL_NUMBER' fval = ps_forn-tel_number ). ENDIF.
*    IF ps_fornx-fax_number = 'X'. zcl_bdc=>add( fnam = 'SZA1_D0100-FAX_NUMBER' fval = ps_forn-fax_number ). ENDIF.
*    IF ps_fornx-mob_number = 'X'. zcl_bdc=>add( fnam = 'SZA1_D0100-MOB_NUMBER' fval = ps_forn-mob_number ). ENDIF.
*    IF ps_fornx-smtp_addr  = 'X'. zcl_bdc=>add( fnam = 'SZA1_D0100-SMTP_ADDR'  fval = ps_forn-smtp_addr ).  ENDIF.
*    IF ps_fornx-post_code1 = 'X' OR ps_fornx-region = 'X'.
*      zcl_bdc=>add( fnam = 'ADDR1_DATA-TAXJURCODE' fval = '' ).
*    ENDIF.
*    zcl_bdc=>add( fnam = 'ADDR1_DATA-LANGU' fval = 'PT' ).
*
*    CLEAR l_pos.
*    LOOP AT pt_tel_tab INTO ls_tel_tab.
*      l_pos = ls_tel_tab-pos.
*      CONDENSE l_pos.
*      zcl_bdc=>add( prog = 'SAPLSZA6' dynpro = '0200' dynbg = 'X'              ).
*      CONCATENATE 'ADTEL-TEL_NUMBER(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = 'BDC_CURSOR'           fval = l_txt                 ).
*      zcl_bdc=>add( fnam = 'BDC_OKCODE'           fval = '=CONT'               ).
*      CONCATENATE 'ADTEL-TEL_NUMBER(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_tel_tab-telefone                    ).
*      CONCATENATE 'ADTEL-TEL_EXTENS(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_tel_tab-extensao                    ).
*      CONCATENATE 'ADTEL-REMARK(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_tel_tab-remark                      ).
*    ENDLOOP.
*
*  ENDIF.
*
******************************************************************************************************************************
**** Alterando os Celulares
******************************************************************************************************************************
*
*  IF pt_cel_tab[] IS NOT INITIAL.
*
*    zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0111' dynbg = 'X' ).
*    zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=$MMO' ).
*    IF ps_fornx-name1      = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-NAME1'      fval = ps_forn-name1 ).      ENDIF.
*    IF ps_fornx-sortl      = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-SORT1'      fval = ps_forn-sortl ).      ENDIF.
*    IF ps_fornx-street     = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-STREET'     fval = ps_forn-street ).     ENDIF.
*    IF ps_fornx-str_suppl3 = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-STR_SUPPL3' fval = ps_forn-str_suppl3 ). ENDIF.
...
*
*    CLEAR l_pos.
*    LOOP AT pt_cel_tab INTO ls_cel_tab.
*      l_pos = ls_cel_tab-pos.
*      CONDENSE l_pos.
*      zcl_bdc=>add( prog = 'SAPLSZA6' dynpro = '0200' dynbg = 'X'              ).
*      CONCATENATE 'ADTEL-TEL_NUMBER(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = 'BDC_CURSOR'           fval = l_txt                 ).
*      zcl_bdc=>add( fnam = 'BDC_OKCODE'           fval = '=CONT'               ).
*      CONCATENATE 'ADTEL-TEL_NUMBER(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_cel_tab-celular                    ).
*      CONCATENATE 'ADTEL-REMARK(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_cel_tab-remark                      ).
*    ENDLOOP.
*
*  ENDIF.
*
...
******************************************************************************************************************************
*
*  IF pt_fax_tab[] IS NOT INITIAL.
*
*    zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0111' dynbg = 'X' ).
*    zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=$MFA' ).
*    IF ps_fornx-name1      = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-NAME1'      fval = ps_forn-name1 ).      ENDIF.
*    IF ps_fornx-sortl      = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-SORT1'      fval = ps_forn-sortl ).      ENDIF.
*    IF ps_fornx-street     = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-STREET'     fval = ps_forn-street ).     ENDIF.
*    IF ps_fornx-str_suppl3 = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-STR_SUPPL3' fval = ps_forn-str_suppl3 ). ENDIF.
...
*
*    CLEAR l_pos.
*    LOOP AT pt_fax_tab INTO ls_fax_tab.
*      l_pos = ls_fax_tab-pos.
*      CONDENSE l_pos.
*      zcl_bdc=>add( prog = 'SAPLSZA6' dynpro = '0300' dynbg = 'X'            ).
*      zcl_bdc=>add( fnam = 'BDC_OKCODE'           fval = '=CONT'             ).
*      CONCATENATE 'ADFAX-FAX_NUMBER(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = 'BDC_CURSOR'           fval = l_txt               ).
*      CONCATENATE 'ADFAX-FAX_NUMBER(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_fax_tab-fax                       ).
*      CONCATENATE 'ADFAX-FAX_EXTENS(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_fax_tab-extensao                  ).
*      CONCATENATE 'ADFAX-REMARK(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_fax_tab-remark                    ).
*    ENDLOOP.
*
*  ENDIF.
*
...
******************************************************************************************************************************
*
*  IF pt_email_tab[] IS NOT INITIAL.
*
*    zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0111' dynbg = 'X' ).
*    zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=$INT' ).
*    IF ps_fornx-name1      = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-NAME1'      fval = ps_forn-name1 ).      ENDIF.
*    IF ps_fornx-sortl      = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-SORT1'      fval = ps_forn-sortl ).      ENDIF.
*    IF ps_fornx-street     = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-STREET'     fval = ps_forn-street ).     ENDIF.
*    IF ps_fornx-str_suppl3 = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-STR_SUPPL3' fval = ps_forn-str_suppl3 ). ENDIF.
...
*
*    CLEAR l_pos.
*    LOOP AT pt_email_tab INTO ls_email_tab.
*      l_pos = ls_email_tab-pos.
*      CONDENSE l_pos.
*      zcl_bdc=>add( prog = 'SAPLSZA6' dynpro = '0600' dynbg = 'X'            ).
*      CONCATENATE 'ADSMTP-SMTP_ADDR(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = 'BDC_CURSOR'           fval = l_txt               ).
*      zcl_bdc=>add( fnam = 'BDC_OKCODE'           fval = '=CONT'             ).
*      CONCATENATE 'ADSMTP-SMTP_ADDR(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_email_tab-email                   ).
*      CONCATENATE 'ADSMTP-REMARK(' l_pos ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_email_tab-remark                  ).
*    ENDLOOP.
*
*  ENDIF.
*
...
*
*  zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0111' dynbg = 'X' ).
*  zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=VW' ).
*  IF ps_fornx-name1      = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-NAME1'      fval = ps_forn-name1 ).      ENDIF.
*  IF ps_fornx-sortl      = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-SORT1'      fval = ps_forn-sortl ).      ENDIF.
*  IF ps_fornx-street     = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-STREET'     fval = ps_forn-street ).     ENDIF.
*  IF ps_fornx-str_suppl3 = 'X'. zcl_bdc=>add( fnam = 'ADDR1_DATA-STR_SUPPL3' fval = ps_forn-str_suppl3 ). ENDIF.
...
*
******************************************************************************************************************************
**** Alterando os Controles
******************************************************************************************************************************
*
*  zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0120' dynbg = 'X' ).
*  zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=VW' ).
**  zcl_bdc=>add( fnam = 'LFA1-STCD1' fval = '44555666000122' ).
*  CASE ps_forn-ktokk.
*    WHEN c_pessoa_juridica.
*      IF ps_fornx-stcd1 = 'X'. zcl_bdc=>add( fnam = 'LFA1-STCD1' fval = ps_forn-stcd1 ). ENDIF.
*      IF ps_fornx-stcd4 = 'X'. zcl_bdc=>add( fnam = 'LFA1-STCD4' fval = ps_forn-stcd4 ). ENDIF.
*      IF ps_fornx-stcd3 = 'X'. zcl_bdc=>add( fnam = 'LFA1-STCD3' fval = ps_forn-stcd3 ). ENDIF.
*    WHEN c_pessoa_fisica.
*      IF ps_fornx-stcd1 = 'X'. zcl_bdc=>add( fnam = 'LFA1-STCD2' fval = ps_forn-stcd1 ). ENDIF.
*      zcl_bdc=>add( fnam = 'LFA1-STKZN' fval = 'X' ).
*  ENDCASE.
*
******************************************************************************************************************************
**** Alterando Bancos
...
*
*    l_idx = 0.
*    WHILE l_idx < sy-dbcnt.
*      _inc l_idx.
*      zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0130' dynbg = 'X' ).
*      zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=BDEL' ).
*    ENDWHILE.
*
*    zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0130' dynbg = 'X' ).
*    zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '/00' ).
*    l_idx = 0.
*    LOOP AT pt_banco INTO ls_banco.
*      IF l_idx > 0.
*        zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0130' dynbg = 'X' ).
*        zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '/00' ).
*      ENDIF.
...
*      _inc l_idx.
*
*      CONCATENATE 'LFBK-BANKS(' l_idx ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_banco-banks ).
*      CONCATENATE 'LFBK-BANKL(' l_idx ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_banco-bankl ).
*      CONCATENATE 'LFBK-BANKN(' l_idx ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_banco-bankn ).
*      CONCATENATE 'LFBK-KOINH(' l_idx ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_banco-koinh ).
*      CONCATENATE 'LFBK-BKONT(' l_idx ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_banco-bkont ).
*      CONCATENATE 'LFBK-BVTYP(' l_idx ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_banco-bvtyp ).
*
*      PERFORM consulta_banco USING ls_banco-banks ls_banco-bankl CHANGING p_subrc.
*      IF p_subrc NE 0.
*        zcl_bdc=>add( prog = 'SAPLBANK' dynpro = '0100' dynbg = 'X' ).
*        zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=ENTR' ).
*        zcl_bdc=>add( fnam = 'BNKA-BANKA' fval = ls_banco-banka ).
*        zcl_bdc=>add( fnam = 'BNKA-PROVZ' fval = ls_banco-provz ).
*        zcl_bdc=>add( fnam = 'BNKA-STRAS' fval = ls_banco-stras ).
*        zcl_bdc=>add( fnam = 'BNKA-ORT01' fval = ls_banco-ort01 ).
*        zcl_bdc=>add( fnam = 'BNKA-BRNCH' fval = ls_banco-brnch ).
*      ENDIF.
*
*      IF l_idx = 5.
*        zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0130' dynbg = 'X' ).
*        zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=P+' ).
*        l_idx = 0.
*      ENDIF.
*
*    ENDLOOP.
...
******************************************************************************************************************************
*
*  zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0380' dynbg = 'X' ).
*  zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=VW'              ).
*
*  CLEAR l_pos.
*  LOOP AT pt_contato_tab INTO ls_contato_tab.
*    l_pos = ls_contato_tab-pos.
*    CONDENSE l_pos.
*    CONCATENATE 'KNVK-NAMEV(' l_pos ')' INTO l_txt.
*    zcl_bdc=>add( fnam = 'BDC_CURSOR' fval = l_txt              ).
*    CONCATENATE 'KNVK-NAMEV(' l_pos ')' INTO l_txt.
*    zcl_bdc=>add( fnam = l_txt fval = ls_contato_tab-nome       ).
*    CONCATENATE 'KNVK-NAME1(' l_pos ')' INTO l_txt.
*    zcl_bdc=>add( fnam = l_txt fval = ls_contato_tab-sobrenome  ).
*  ENDLOOP.
*
******************************************************************************************************************************
**** AdministraÃ§Ã£o Conta Contabilidade
******************************************************************************************************************************
*
*  zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0210' dynbg = 'X' ).
*  zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=VW' ).
**  zcl_bdc=>add( fnam = 'LFB1-AKONT' fval = c_akont ).
**  CASE ps_forn-ktokk.
**    WHEN c_pessoa_juridica.
**      zcl_bdc=>add( fnam = 'LFB1-FDGRV' fval = 'FORN NAC' ).
**    WHEN c_pessoa_fisica.
**      zcl_bdc=>add( fnam = 'LFB1-FDGRV' fval = 'FOR PESS F' ).
**  ENDCASE.
*
*  zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0215' dynbg = 'X' ).
*  zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=VW' ).
** IF ps_fornx-zterm = 'X'. zcl_bdc=>add( fnam = 'LFB1-ZTERM' fval = ps_forn-zterm ). ENDIF.
*  zcl_bdc=>add( fnam = 'LFB1-ZWELS' fval = c_zwels ).
*
*  zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0220' dynbg = 'X' ).
*  zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=VW' ).
*
**&- Cadastro IR
*  IF pt_ir[] IS NOT INITIAL.
*
*    PERFORM get_lfbw USING p_lifnr p_bukrs CHANGING lt_lfbw.
**    PERFORM exclui_lfbw USING p_lifnr p_bukrs.
*
**    sy-dbcnt = LINES( lt_lfbw ).
**    IF sy-dbcnt > 0.
**      l_idx = 0.
**      WHILE l_idx < sy-dbcnt.
**        _inc l_idx.
**
**        zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0610' dynbg = 'X' ).
**        zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=LDEL' ).
**
**        zcl_bdc=>add( prog = 'BDC_SUBSCR' fval = 'SAPMFWTV 0610WT_WITS' ).
**        zcl_bdc=>add( prog = 'BDC_CURSOR' fval = 'LFBW-WT_WITH(01)' ).
**
**      ENDWHILE.
**    ENDIF.
*
****    zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0610' dynbg = 'X' ).
*****    zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=VW' ).
****    zcl_bdc=>add( fnam = 'LFB1-QLAND' fval = '508' ).
****    zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=ENTR' ).
*
*    DATA:
...
*      zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0610' dynbg = 'X' ).
*      zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=LDEL' ).
*      zcl_bdc=>add( fnam = 'BDC_CURSOR' fval = 'LFBW-WITHT(01)' ).
*    ENDLOOP.
*
*    zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0610' dynbg = 'X' ).
*    zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=VW' ).
...
*
*    l_idx = 0.
*    LOOP AT pt_ir INTO ls_ir.
*      _inc l_idx.
*
*      CONCATENATE 'LFBW-WITHT(' l_idx ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_ir-witht ).
*      CONCATENATE 'LFBW-WT_WITHCD(' l_idx ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = ls_ir-wt_withcd ).
*      CONCATENATE 'LFBW-WT_SUBJCT(' l_idx ')' INTO l_txt.
*      zcl_bdc=>add( fnam = l_txt fval = 'X' ).
*
*      IF l_idx = 6.
*        zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0610' dynbg = 'X' ).
*        zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=P+' ).
...
*
**&- Inicio - 01/08/2017
*  zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0310' dynbg = 'X' ).
*  zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=0510' ).
*
*  zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0510' dynbg = 'X' ).
*  zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=PF03' ).
*  zcl_bdc=>add( fnam = 'LFA1-SPERR' fval = 'X' ).
*  zcl_bdc=>add( fnam = 'LFA1-SPERM' fval = 'X' ).
*  zcl_bdc=>add( fnam = 'LFA1-SPERQ' fval = '99' ).
*
**&- Fim - 01/08/2017
*
...
*  zcl_bdc=>add( prog = 'SAPMF02K' dynpro = '0310' dynbg = 'X' ).
*  zcl_bdc=>add( fnam = 'BDC_OKCODE' fval = '=UPDA' ).
*  zcl_bdc=>add( fnam = 'LFM1-WAERS' fval = c_moeda ).
*
*  zcl_bdc=>call_transaction( EXPORTING iv_tcode    = 'XK02'
*                             IMPORTING et_messages = lt_msg ).
*
*  READ TABLE lt_msg TRANSPORTING NO FIELDS WITH KEY type = 'S'
*                                                    id = 'F2'
*                                                    number = '056'.
*  IF sy-subrc <> 0.
*    PERFORM set_lfbw USING lt_lfbw.
*  ENDIF.
*
*  PERFORM converte_mensagem USING lt_msg CHANGING pt_msg .
*
*  DATA:
*    lv_qid   LIKE apqi-qid,
*    lv_group LIKE  apqi-groupid.
*
*  READ TABLE lt_msg TRANSPORTING NO FIELDS WITH KEY type = 'E'.
*  IF sy-subrc = 0.
*    CONCATENATE 'U' p_lifnr+3 p_bukrs p_ekorg 'UPD' INTO lv_group.
*    zcl_bdc=>bdc_new( EXPORTING iv_group = lv_group IMPORTING ev_qid = lv_qid ).
*
*    zcl_bdc=>bdc_insert( 'XK02' ).
*
*    zcl_bdc=>bdc_close( ).
*  ENDIF.
*ENDFORM.                    " UPD_FORNECEDOR
*&---------------------------------------------------------------------*
*&      Form  CONSULTA_BANCO
*&---------------------------------------------------------------------*
*FORM consulta_banco  USING p_banks TYPE lfbk-banks
*                           p_bankl TYPE bnka-bankl
*                     CHANGING p_subrc TYPE sy-subrc.
*  TABLES bnka.
*  DATA l_banks TYPE bnka-banks.
*
*  l_banks = p_banks.
*
*  SELECT SINGLE *
...
*  p_subrc = sy-subrc.
*
*ENDFORM.                    " CONSULTA_BANCO

*&---------------------------------------------------------------------*
*&      Form  GET_LFBW
*&---------------------------------------------------------------------*
*FORM get_lfbw  USING    p_lifnr TYPE lfa1-lifnr
*                        p_bukrs TYPE lfbw-bukrs
*               CHANGING pt_lfbw TYPE ty_lfbw.
*
*  SELECT *
*  INTO TABLE pt_lfbw
*  FROM lfbw
...
*&      Form  SET_LFBW
*&---------------------------------------------------------------------*
*FORM set_lfbw  USING    pt_lfbw TYPE ty_lfbw.
*  UPDATE lfbw FROM TABLE pt_lfbw.
...
FORM f_create_fill_purchasing_data  CHANGING p_t_vendor_purchasin TYPE vmds_ei_purchasing_t.
  ...
  CONSTANTS:
    ...
    lc_zterm_tb00          TYPE dzterm VALUE 'TB00'. " A Vista
  ...
  MOVE:
    ...
    lc_zterm_tb00           TO ls_purchasing-data-zterm, " Chave de condições de pagamento
